...
const PersonalAction = ({ employeeData }) => {
  return (
    <div className=" relative flex flex-col bg-white dark:bg-black mt-16 border border-black dark:border-slate-600 rounded-b-md shadow-lg px-8 ">
      {/* Header Section */}
      ...
      <Form className=" grid grid-cols-1 gap-12 ">
        <div className="bg-white dark:bg-black text-lg p-6 rounded-lg space-y-4">
          <div>
